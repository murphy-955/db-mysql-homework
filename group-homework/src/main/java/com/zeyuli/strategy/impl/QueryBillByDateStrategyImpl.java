...
public class QueryBillByDateStrategyImpl implements BillQueryStrategy {
     ...
     *
     * @param vo 包含了查询的<b>日期范围</b>，<b>token</b>等，见 {@link GetBillListOrderByDateVo}
    ...
    public List<GetBillListBo> queryBillList(GetBillListOrderByDateVo vo) {
        ...
        // 3. 查数据库
        billList = queryBillMapper.queryBillListOrderByDate(vo);
        if (!billList.isEmpty()) {
    ...
    public String getSearchType() {
        return SearchTypeEnum.DATE_RANGE.name();
    }
}
