...
- **请求方式：POST**
- **请求地址：`/api/bill/getBillList?page=1&limit=10`**
- **请求参数：**
    - **请求体：**
  ```json5
  {
...
- **请求方式：POST**
- **请求地址：`/api/query/getBillList?page=1&limit=10`**
- **请求参数：**
    - **请求体：**
  ```json5
  {
